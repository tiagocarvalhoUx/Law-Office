          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-4">
              {['instagram', 'facebook', 'pinterest'].map((social, idx) => (
                <a key={idx} href="#" className="w-12 h-12 rounded-2xl bg-white/10 hover:bg-white/20 backdrop-blur-sm flex items-center justify-center transition-all duration-300 hover:scale-110 border border-white/20">
